...
public class WristCommands {
  ...
  public static final BasePosition CORAL_WRIST_INTAKE = new BasePosition(0.575); // was 0.66
  public static final BasePosition CORAL_WRIST_SCORE = new BasePosition(0.14); // was 0.20
