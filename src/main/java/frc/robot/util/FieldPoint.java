...
public class FieldPoint {
  ...
  public static final Pose2d REEF_GH = new Pose2d(5.8305, 4.03475, new Rotation2d(Units.degreesToRadians(180)));
  public static final Pose2d REEF_IJ = new Pose2d(5.19675, 5.17, new Rotation2d(Units.degreesToRadians(120)));
  public static final Pose2d REEF_KL = new Pose2d(3.83175, 5.18, new Rotation2d(Units.degreesToRadians(60)));
  public static final Pose2d REEF_AB =
      new Pose2d(3.1492500000000003, 4.015249999999999, new Rotation2d(0));
  public static final Pose2d REEF_CD = new Pose2d(3.83175, 2.8354999999999997, new Rotation2d(Units.degreesToRadians(300)));
  public static final Pose2d REEF_EF = new Pose2d(5.175, 2.855, new Rotation2d(Units.degreesToRadians(240)));
